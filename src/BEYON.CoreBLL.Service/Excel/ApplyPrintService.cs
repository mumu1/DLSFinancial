...
namespace BEYON.CoreBLL.Service.Excel
{
    public class ApplyPrintService : IApplyPrintService
    {
         ...
         private bool ExecuteProcess(String path, string execute,string parameters)
        {
            ...
            //设置外部程序名
            Info.FileName  =  String.Format(@"{0}\{1}", path, execute);
        ...
        private String SaveExcel(String filePath, String fileName, ApplicationForm applicationForm, IList<PersonalRecord> persons)
        {
            ////1.删除已有文件
