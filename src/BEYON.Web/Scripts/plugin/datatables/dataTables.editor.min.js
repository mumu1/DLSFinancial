...
;f[(d0+K4O.y3+K4O.e3+K4O.L1A+K4O.e3+t9)]((S37+X4A),i,q,y,c.data,k);if(i==="create"||i===(n6+B0D))for(g=0;c.data!== undefined && g<c.data.length;g++){n=c.data[g];f[(y07+P4+K4O.L1A)]((K4O.c4A+K4O.U0+H8+U9),[c,n,i]);if(i===(K4O.S9+s1)){f[(y07+o67+y7D)]((L7A+K4O.o9+K4O.e3+P1A),[c,n]);f[(G1D+K4O.e3+K4O.L1A+K4O.e3+m1+b77+D07)]((K4O.S9+u1A+K4O.L1A+K4O.o9),l,n,k);f[Y9]([(F87+P57),"postCreate"],[c,n]);}
...
,i18n:{create:{button:(B2D+c17),title:"创建新行",submit:"创建"}
,edit:{button:(b27+B0D),title:"修改选中行",submit:"更新"}
,remove:{button:(k47+K4O.B5A+K4O.o9+P1A),title:"删除选中行",submit:"删除",confirm:{_:("你确定要删除 %d 行?"),1:("你确定要删除 1 行?")}
}
