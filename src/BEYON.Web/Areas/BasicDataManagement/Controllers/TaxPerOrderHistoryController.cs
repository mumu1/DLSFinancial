...
namespace BEYON.Web.Areas.BasicDataManagement.Controllers
{
    public class TaxPerOrderHistoryController : Controller
    {
        ...
        public ActionResult ExportAllExcels()
        {
            ...
            IList<String> headNames = new List<String> { "期间", "申请单流水号", "姓名", "人员类型", "证件类型", "证件号码", "支付类型", "金额", "是否含税", "应纳税额", "税后金额", "税前金额", "课题号", "课题名称", "课题负责人", "经办人", "开户银行", "银行账号", "收款账号省份", "收款账号地市", "开户行详细名称", "联系电话" };
