...
namespace BEYON.Component.Data.Configurations.Plot
{
    ...
    ///   实体类数据表关系配置——角色信息
    /// </summary>
    internal partial class ImportAntsitesConfiguration : EntityTypeConfiguration<ImportAntsites>
    {
        public ImportAntsitesConfiguration()
        {
            ImportAntsitesConfigurationAppend();
        }
         /// <summary>
        /// 额外的数据映射
        /// </summary>
        partial void ImportAntsitesConfigurationAppend();
    }
}
