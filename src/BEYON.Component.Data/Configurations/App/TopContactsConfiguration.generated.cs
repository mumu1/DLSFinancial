...
namespace BEYON.Component.Data.Configurations.App
{
    ...
    ///   实体类数据表关系配置——角色信息
    /// </summary>
    internal partial class TopContactsConfiguration : EntityTypeConfiguration<TopContacts>
    {
        public TopContactsConfiguration()
        {
            TopContactsConfigurationAppend();
        }
         /// <summary>
        /// 额外的数据映射
        /// </summary>
        partial void TopContactsConfigurationAppend();
    }
}
