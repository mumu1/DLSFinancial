...
namespace BEYON.Component.Data.Configurations.Plot
{
    ...
    ///   实体类数据表关系配置——角色信息
    /// </summary>
    internal partial class TaxPerOrderConfiguration : EntityTypeConfiguration<TaxPerOrder>
    {
        public TaxPerOrderConfiguration()
        {
            TaxPerOrderConfigurationAppend();
        }
         /// <summary>
        /// 额外的数据映射
        /// </summary>
        partial void TaxPerOrderConfigurationAppend();
    }
}
