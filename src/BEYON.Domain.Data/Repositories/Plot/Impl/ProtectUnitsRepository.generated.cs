...
namespace BEYON.Domain.Data.Repositories.Plot.Impl
{
    ...
    ///   仓储操作层实现——调前标绘信息
    /// </summary>
    public partial class ProtectUnitsRepository : EFRepositoryBase<ProtectUnits, Int32>, IProtectUnitsRepository
    {
        public ProtectUnitsRepository(IUnitOfWork unitOfWork)
            : base()
        { }
     }
}
