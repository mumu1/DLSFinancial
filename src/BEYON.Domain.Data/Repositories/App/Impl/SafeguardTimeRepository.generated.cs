...
namespace BEYON.Domain.Data.Repositories.App.Impl
{
    ...
    ///   仓储操作层实现——用户信息
    /// </summary>
    public partial class SafeguardTimeRepository : EFRepositoryBase<SafeguardTime, Int32>, ISafeguardTimeRepository
    {
        public SafeguardTimeRepository(IUnitOfWork unitOfWork)
            : base()
        { }
     }
}
