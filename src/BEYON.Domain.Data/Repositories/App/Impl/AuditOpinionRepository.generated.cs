...
namespace BEYON.Domain.Data.Repositories.App.Impl
{
    ...
    ///   仓储操作层实现——用户信息
    /// </summary>
    public partial class AuditOpinionRepository : EFRepositoryBase<AuditOpinion, Int32>, IAuditOpinionRepository
    {
        public AuditOpinionRepository(IUnitOfWork unitOfWork)
            : base()
        { }
     }
}
